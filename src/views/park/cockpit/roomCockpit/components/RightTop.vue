    ...
    <div class="flex-auto relative">
      <div class="absolute inset-0 flex gap-[10px]">
        <div class="h-full aspect-ratio-1"
          ><v-chart autoresize :option="option" v-if="isEcharts"></v-chart
        ></div>
        <div class="h-full flex-auto flex justify-center items-center">
          <div class="progress-container w-full">
            <div class="progress">
              <div class="w-full flex justify-between items-center text-4">
                <span class="color-[#6087d0]">电池备用时间</span>
            ...
            <div class="progress">
              <div class="w-full flex justify-between items-center text-4">
                <span class="color-[#6087d0]">电池电压</span>
            ...
            <div class="progress">
              <div class="w-full flex justify-between items-center text-4">
                <span class="color-[#6087d0]">电池电阻</span>
...
<script setup lang="ts">
  import { getPowerDistribution } from '@/api/cockpit/roomManage';
  ...
  const getData = async () => {
    ...
    const res = await getPowerDistribution(props.id);
    isEcharts.value = true;
    viewData.value = res;
    setOption(Number(res.loadRate));
  };
  /**
   * @description: 设置图表数据
   */
